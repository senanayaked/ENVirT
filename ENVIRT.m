...
function ENVIRT(spectrum_file, n_reads, avg_read_length, overlap_length,trim_length, M_min, M_max, p_res, p_max, L_res, L_min, L_max, n_windows, result_folder, persist_intermediates)
